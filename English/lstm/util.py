...
def get_args():
    ...
    parser.add_argument('--attention-hops', type=int, default=10,
    ...
    parser.add_argument('--load', type=str, default='../lstm_data/lstm/nfc512_batch256_hop.epoch-29.pt',
                        help='path to load the final model')
    parser.add_argument('--test-model', type=str, default='../lstm_data/lstm/nfc512_batch256_hop.epoch-29.pt',
                        help='path to load the final model')
